...
var _debois$elm_mdl$Tab$distance = F2(
	function (down, up) {
		return A2(_elm_lang$core$Maybe$withDefault, 0, down.x) - A2(_elm_lang$core$Maybe$withDefault, 0, up.x);
	});
var _debois$elm_mdl$Tab$tabs = function (model) {
	return {
		ctor: '_Tuple2',
		_0: A2(
			_elm_lang$core$List$map,
			function (cat) {
				return _elm_lang$html$Html$text(cat);
			},
			model.categories),
		_1: _elm_lang$core$Native_List.fromArray(
			[])
...
var _debois$elm_mdl$Tab$header = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Swipe tabs')
						])),
					_debois$elm_mdl$Material_Layout$spacer
				]))
		]);
};
var _debois$elm_mdl$Tab$Model = F4(
	function (a, b, c, d) {
		return {mdl: a, selectedTab: b, categories: c, downCoord: d};
	});
var _debois$elm_mdl$Tab$Coord = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _debois$elm_mdl$Tab$initialModel = {
	mdl: _debois$elm_mdl$Material$model,
	selectedTab: 1,
	categories: _elm_lang$core$Native_List.fromArray(
		['cars', 'bikes', 'planes']),
	downCoord: A2(
		_debois$elm_mdl$Tab$Coord,
		_elm_lang$core$Maybe$Just(0.0),
		_elm_lang$core$Maybe$Just(0.0))
};
var _debois$elm_mdl$Tab$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_debois$elm_mdl$Tab$initialModel,
	_elm_lang$core$Native_List.fromArray(
		[]));
var _debois$elm_mdl$Tab$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Down':
				var _p1 = _p0._0;
				var co = A2(_elm_lang$core$Debug$log, 'coord', _p1);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'Up':
				var dif = A2(
					...
					'dif',
					A2(
						_debois$elm_mdl$Tab$distance,
						model.downCoord,
						A2(_elm_lang$core$Debug$log, 'up', _p0._0)));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							downCoord: A2(_debois$elm_mdl$Tab$Coord, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'SelectTab':
...
var _debois$elm_mdl$Tab$downDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_debois$elm_mdl$Tab$Coord,
	_elm_lang$core$Json_Decode$maybe(
		A2(
	...
	_elm_lang$core$Json_Decode$maybe(
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				['touches', '0', 'clientY']),
			_elm_lang$core$Json_Decode$float)));
var _debois$elm_mdl$Tab$upDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_debois$elm_mdl$Tab$Coord,
	_elm_lang$core$Json_Decode$maybe(
		A2(
	...
	_elm_lang$core$Json_Decode$maybe(
		A2(
			...
			_elm_lang$core$Json_Decode$float)));
var _debois$elm_mdl$Tab$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _debois$elm_mdl$Tab$SelectTab = function (a) {
	return {ctor: 'SelectTab', _0: a};
};
var _debois$elm_mdl$Tab$Up = function (a) {
	return {ctor: 'Up', _0: a};
};
var _debois$elm_mdl$Tab$Down = function (a) {
	return {ctor: 'Down', _0: a};
};
var _debois$elm_mdl$Tab$mainView = function (model) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Events$on,
					'touchstart',
					A2(_elm_lang$core$Json_Decode$map, _debois$elm_mdl$Tab$Down, _debois$elm_mdl$Tab$downDecoder)),
					A2(
					_elm_lang$html$Html_Events$on,
					'touchend',
					A2(_elm_lang$core$Json_Decode$map, _debois$elm_mdl$Tab$Up, _debois$elm_mdl$Tab$upDecoder))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
...
var _debois$elm_mdl$Tab$view = function (model) {
	return A4(
		_debois$elm_mdl$Material_Layout$render,
		_debois$elm_mdl$Tab$Mdl,
		model.mdl,
		_elm_lang$core$Native_List.fromArray(
			[
				_debois$elm_mdl$Material_Layout$selectedTab(model.selectedTab),
				_debois$elm_mdl$Material_Layout$onSelectTab(_debois$elm_mdl$Tab$SelectTab),
				_debois$elm_mdl$Material_Layout$fixedHeader
			]),
		{
			header: _debois$elm_mdl$Tab$header(model),
			drawer: _elm_lang$core$Native_List.fromArray(
				[]),
			tabs: _debois$elm_mdl$Tab$tabs(model),
			main: _debois$elm_mdl$Tab$mainView(model)
		});
};
var _debois$elm_mdl$Tab$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _debois$elm_mdl$Tab$init,
			view: _debois$elm_mdl$Tab$view,
			update: _debois$elm_mdl$Tab$update,
...
var Elm = {};
Elm['Tab'] = Elm['Tab'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Tab'], 'Tab', typeof _debois$elm_mdl$Tab$main === 'undefined' ? null : _debois$elm_mdl$Tab$main);
